...
namespace GalleryNestApp.ViewModel
{
    public class FavouriteViewModel : ObservableObject
    {
        ...
        public FavouriteViewModel(PhotoService photoService, AlbumService albumService, SelectionService selectionService, PersonService personService, INavigationService navigationService)
        {
        ...
        private async Task LoadDataAsync(bool reset = false, int pageSize = PageSize)
        {
            ...
            try
            {
                ...
                var pagedResult = await PhotoService.LoadFavouritePhotos(CurrentPage, pageSize);
