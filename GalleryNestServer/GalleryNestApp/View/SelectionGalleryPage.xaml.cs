...
{
    /// <summary>
    /// Логика взаимодействия для SelectionGalleryPage.xaml
    /// </summary>
    public partial class SelectionGalleryPage : Page
    {
        private SelectionGalleryViewModel _selectionGalleryViewModel;
        ...
        public SelectionGalleryPage(SelectionGalleryViewModel albumGalleryViewModel, WebView2Provider webView2Provider)
        {
            this._selectionGalleryViewModel = albumGalleryViewModel;
            this._webView2Provider = webView2Provider;
            InitializeComponent();
            DataContext = this._selectionGalleryViewModel;
        }
        ...
        private async void WebView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                _selectionGalleryViewModel.LoadImageToWebView(webView, photoId);
            }
            catch (Exception ex)
            {
